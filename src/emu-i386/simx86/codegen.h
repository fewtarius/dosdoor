...
/* x386 */
#define GetSWord(w)	*((unsigned short *)(w))=*((unsigned short *)(uintptr_t)HOST_ADDR(LONG_SS+sp))
#define GetSLong(l)	*((unsigned int *)(l))=*((unsigned int *)(uintptr_t)HOST_ADDR(LONG_SS+sp))
#define PutSWord(w)	*((unsigned short *)(uintptr_t)HOST_ADDR(LONG_SS+sp))=*((unsigned short *)(w))
#define PutSLong(l)	*((unsigned int *)(uintptr_t)HOST_ADDR(LONG_SS+sp))=*((unsigned int *)(l))
