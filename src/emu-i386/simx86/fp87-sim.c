...
/* Full x87 FPU emulation using host FPU */
...
#else /* non-x86: minimal FPU stubs */
...
static int Fp87_op_stub(int exop, int reg)
{
    /* FPU not implemented on this architecture */
    return 0;
}

void init_emu_npu(void)
{
    Fp87_op = Fp87_op_stub;
}
