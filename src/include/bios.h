...
/* On x86, BIOS symbols are assembly labels. Use & to get address. */
#define BIOS_SYM(x) ((unsigned long)&(x))
...
#else
/* On non-x86, BIOS ROM is a pre-assembled byte array (bios_data.c).
   These are pointers into the array. Value IS the address. */
#define BIOS_SYM(x) ((unsigned long)(x))
extern unsigned char *bios_f000;
extern unsigned char *bios_f000_endpart1;
extern unsigned char *bios_f000_part2;
extern unsigned char *bios_f000_end;
extern unsigned char *bios_f000_int10ptr;
extern unsigned char *bios_f000_bootdrive;
extern unsigned char *bios_f000_int10_old;
extern unsigned char *bios_in_int10_callback;
#endif

#if defined(__x86_64__) || defined(__i386__)
extern char LFN_string[];
#else
extern unsigned char *LFN_string;
#endif
...
#else
/* On non-x86, these are pointers into pre-assembled bios_rom_data */
extern unsigned char *INT16_dummy_start;
extern unsigned char *INT16_dummy_end;
extern unsigned char *INT08_dummy_start;
extern unsigned char *INT08_dummy_end;
extern unsigned char *INT70_dummy_start;
extern unsigned char *INT70_dummy_end;
extern unsigned char *DPMI_dummy_start;
extern unsigned char *DPMI_dummy_end;
extern unsigned char *DPMI_dpmi_init;
extern unsigned char *DPMI_return_from_dos;
extern unsigned char *DPMI_return_from_dosint;
extern unsigned char *DPMI_return_from_realmode;
extern unsigned char *DPMI_return_from_dos_memory;
extern unsigned char *DPMI_raw_mode_switch_rm;
extern unsigned char *DPMI_save_restore_rm;

extern unsigned char *MSDOS_srm_start;
extern unsigned char *MSDOS_mouse_callback;
extern unsigned char *MSDOS_PS2_mouse_callback;
extern unsigned char *MSDOS_srm_end;
extern unsigned char *MSDOS_rpm_start;
extern unsigned char *MSDOS_return_from_rm;
extern unsigned char *MSDOS_rpm_end;

extern unsigned char *PKTDRV_driver_name;
extern unsigned char *PKTDRV_param;
extern unsigned char *PKTDRV_stats;
extern unsigned char *PKTDRV_start;
#endif
