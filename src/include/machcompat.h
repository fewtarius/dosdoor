 ...
 * HISTORY:
 * $Log$
 * Revision 1.3  2005/05/20 00:26:16  bartoldeman
 * It's 2005 this year.
 *
 * Revision 1.2  2004/01/16 20:50:31  bartoldeman
 * Happy new year!
 *
...
#define Addr_8086(x,y)	((uintptr_t)(( ((x) & 0xffff) << 4) + ((y) & 0xffff) + (uintptr_t)lowmem_base))
