...
#else /* non-x86: stubs - real port I/O not available */

static inline void port_real_outb(ioport_t port, Bit8u value) { (void)port; (void)value; }
static inline Bit8u port_real_inb(ioport_t port) { (void)port; return 0xFF; }
static inline void port_real_outw(ioport_t port, Bit16u value) { (void)port; (void)value; }
static inline Bit16u port_real_inw(ioport_t port) { (void)port; return 0xFFFF; }
static inline void port_real_outd(ioport_t port, Bit32u value) { (void)port; (void)value; }
static inline Bit32u port_real_ind(ioport_t port) { (void)port; return 0xFFFFFFFF; }
