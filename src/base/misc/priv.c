...
#ifdef __APPLE__
/* macOS doesn't use privilege escalation */
static int _priv_off(void) { return 1; }
int real_enter_priv_on(saved_priv_status *p) { return 1; }
int real_enter_priv_off(saved_priv_status *p) { return 1; }
int priv_iopl(int pl) { return 0; }
/* set_ioperm is implemented in ports.c */
#endif
...
#else
  dosemu_proc_self_exe = NULL;
  dosemu_proc_self_maps_fd = -1;
#endif
  if (under_root_login)
  {
