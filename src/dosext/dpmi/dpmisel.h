...
/* x86: symbols are assembly labels, arrays work as addresses */
#define DPMI_SEL_OFF(x) (x-DPMI_sel_code_start)
#else
/* non-x86: symbols are pointer variables from dpmisel_data.c */
#define DPMI_SEL_OFF(x) ((unsigned char *)(x)-DPMI_sel_code_start)
#endif
...
#else
extern void		DPMI_direct_transfer(void);
#endif
...
#if defined(__x86_64__) || defined(__i386__)
/* x86: assembly labels are arrays */
...
#else
/* non-x86: pointer variables from dpmisel_data.c */
extern unsigned char	*DPMI_save_restore_pm;
extern unsigned char	*DPMI_raw_mode_switch_pm;
extern unsigned char	*DPMI_return_from_rm_callback;
extern unsigned char	*DPMI_VXD_start;
